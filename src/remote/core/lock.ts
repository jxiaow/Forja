...
export function defaultRemoteStateRoot(): string {
    return path.join(os.homedir(), '.forja');
}
...
export async function executeRemoteAcquireLock(options: ExecuteRemoteAcquireLockOptions): Promise<ExecuteRemoteAcquireLockResult> {
    ...
    const lockDir = homePath('.forja', 'locks', target.targetId);
...
export async function executeRemoteReadLock(options: ExecuteRemoteReadLockOptions): Promise<ExecuteRemoteReadLockResult> {
    ...
    const lockFile = homePath('.forja', 'locks', target.targetId, 'lock.json');
...
async function executeRemoteReleaseByTarget(options: {
    ...
    const lockDir = homePath('.forja', 'locks', options.targetId);
